...
<c:set var="pageTitle" value="수정 페이지" />
...
<section class="section section-detail container mx-auto shadwo">
  <div class="section-top flex justify-center font h-full mt-2">
    ...
    <span class="h-full flex-grow flex justify-center items-center">게시글 수정</span>
    <span class="w-5"></span>
  </div>
    ...
    <div class="write-article py-2">
      <form action="./doModify" method="POST">
        ...
        <div class="form-control">
          ...
          <input type="text" name="title" placeholder="제목을 입력해주세요" class="input input-bordered" value="${param.title}">
        </div>
        <div class="form-control">
          <label class="label">
            <span class="label-text">내용</span>
          </label>
          <textarea name="body" class="textarea h-24 textarea-bordered" placeholder="내용을 입력해주세요.">${param.body}</textarea>
        </div>
